 ...
 *
 */
-(void)bindWithBindKey:(NSString* )bindKey success:(void (^)(id obj))sucessBlock failure:(void (^)(NSError *))failureBlock;

-(void)callRemoteRequest:(MHBaseRequest*)request sucess:(void (^)(id))sucessBlock failure:(void (^)(NSError *))failureBlock;
@end
