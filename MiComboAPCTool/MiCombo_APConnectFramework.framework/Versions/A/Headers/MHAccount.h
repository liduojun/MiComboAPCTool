...
#import "MHPassport.h"
#import "MHAccountConfig.h"
//#ifdef CHINAMOBILE
static NSString* const kMHChinaMobileAuthCancelNotification = @"kMHChinaMobileAuthCancelNotification"; //点击返回按钮的
static NSString* const kMHChinaMobileAuthShowAuthNotification = @"kMHChinaMobileAuthShowAuthNotification"; //显示授权界面的
static NSString* const kMHChinaMobileAuthShowLoginNotification = @"kMHChinaMobileAuthShowLoginNotification"; //显示登录界面的
//#endif
...
- (void)configAccount:(MHAccountConfig *)config;;
@end
